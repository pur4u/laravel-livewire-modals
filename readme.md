...
```console
composer require pur4u/laravel-livewire-modals
```
...
Require `../../vendor/pur4u/laravel-livewire-modals/resources/js/modals` in your app javascript file:

```javascript
require('@popperjs/core');
require('bootstrap');
require('../../vendor/pur4u/laravel-livewire-modals/resources/js/modals');
```
